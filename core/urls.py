...
urlpatterns = [
	...
	path('accounts/profile/borrowed-loans', views.borrowed_loans, name='borrowed_loans'),
	path('accounts/profile/borrowed-loans/<int:page>', views.borrowed_loans, name='borrowed_loans_page'),
	...
	path('accounts/profile/loan-offers', views.loan_offers, name='loan_offers'),
	path('accounts/profile/loan-offers/<int:page>', views.loan_offers, name='loan_offers_page'),
